...
#line 40 "thread_implicit.pgc"
  ...
  for( n = 0; n < nthreads; n++ )
    {
      thrd_create(&threads[n], test_thread, (void *) (n + 1));
    }

  /* wait for thread completion */
  for( n = 0; n < nthreads; n++ )
    {
      thrd_join(threads[n], NULL);
    }
  free(threads);

  /* and check results */
  { ECPGconnect(__LINE__, 0, "ecpg1_regression" , NULL, NULL , NULL, 0); }
#line 62 "thread_implicit.pgc"

  { ECPGdo(__LINE__, 0, 1, NULL, 0, ECPGst_normal, "select count ( * ) from test_thread", ECPGt_EOIT, 
	ECPGt_int,&(l_rows),(long)1,(long)1,sizeof(int), 
	ECPGt_NO_INDICATOR, NULL , 0L, 0L, 0L, ECPGt_EORT);}
#line 63 "thread_implicit.pgc"

  { ECPGtrans(__LINE__, NULL, "commit");}
#line 64 "thread_implicit.pgc"

  { ECPGdisconnect(__LINE__, "CURRENT");}
#line 65 "thread_implicit.pgc"
