...
static pg_thread_key_t descriptor_key;
static pg_thread_once_t descriptor_once = PG_THREAD_ONCE_INIT;
...
{
	pg_thread_key_create(&descriptor_key, descriptor_destructor);
}

static struct descriptor *
get_descriptors(void)
{
	pg_thread_once(&descriptor_once, descriptor_key_init);
	return (struct descriptor *) pg_thread_getspecific(descriptor_key);
}

static void
set_descriptors(struct descriptor *value)
{
	pg_thread_setspecific(descriptor_key, value);
}
