...
XLogReadRecordAlloc(XLogReaderState *state, size_t xl_tot_len, bool allow_oversized)
{
	...
	Assert(state->decode_buffer_head >= state->decode_buffer);
	Assert(state->decode_buffer_head <= state->decode_buffer + state->decode_buffer_size);
	Assert(state->decode_buffer_tail >= state->decode_buffer);
	Assert(state->decode_buffer_tail <= state->decode_buffer + state->decode_buffer_size);

	/* Try to allocate space at the tail of the circular decode buffer. */
