...
/*
 * The default limit for DECLARE_PG_STACK() is very low when using its
 * PG_STACK_USE_ARRAY fallback code (rare).  The code in this module requests a
 * custom size for historical reasons.
 */
