...
PG_CMDTAG(CMDTAG_CREATE_COLLATION_PROVIDER, "CREATE COLLATION_PROVIDER", true, false, false)
...
PG_CMDTAG(CMDTAG_DROP_COLLATION_PROVIDER, "DROP COLLATION PROVIDER", true, false, false)
