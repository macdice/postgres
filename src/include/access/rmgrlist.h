...
PG_RMGR(RM_SMGR_ID, "Storage", smgr_redo, smgr_desc, smgr_identify, NULL, NULL, NULL, smgr_undo, NULL, smgr_undo_desc)
...
PG_RMGR(RM_TEST_ID, "Test", NULL, NULL, NULL, NULL, NULL, NULL, NULL, test_undo_status, test_undo_desc)
